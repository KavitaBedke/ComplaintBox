          ...
          <div class="content">
            <div class="container">
                  ...
                  <div class="col-lg-12">
                      ...
                      <h2 class="text-center">How to complaint?</h2>
                      <br><br><br>
                      ...
                      <div class="col-lg-4">
                        <div class="quotes blg text-center">
                          <h3>Third</h3>
                            <p>The Best way to complaint you can use our online complaints form.</p>
                        </div>
                      </div>
              ...
              <div class="content">
                <div class="col-lg-12">
                  <div class="posts">
                    <?php
                      $db=mysql_query("SELECT * FROM `postss` ");
                      while($data=mysql_fetch_array($db)) {
                      echo "<br> <br> <div class='quotes glow'> ";
                      echo "<h4 class='heading'> Subject : ".$data['subject']."</h4>";
                      echo "<p> Message from Teacher : ".$data['story']."<br><br>";
                      echo "  ".$data['session_name']."<br>";
